...
public class ControllerTest {
    ...
    public void DefaultTurnNoErr() {
        ...
        //Player1 has to choose the cards
        ...
        deck.add(c1);
        deck.add(c2);
        DeckChoice deckChoice = new DeckChoice(game.getPlayers().get(0),deck);
        ...
        CardChoice cardChoice = new CardChoice(game.getPlayers().get(1),game.getCards().get(0));
        ...
        assertEquals(true,player1.getTurn() instanceof DemeterTurn);
        PlayerMove p1M = new PlayerMove(player1,0,1);
        PlayerBuild p1B = new PlayerBuild(player1,0,2);
        controller.update(p1M);
        assertEquals(player1.getWorker1(),board.getBox(0,1).getPawn());
